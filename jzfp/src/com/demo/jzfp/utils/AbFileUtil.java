...
public class AbFileUtil {
	...
	public static Bitmap getBitmapFromURL(String url,int type,int desiredWidth, int desiredHeight){
		...
		try {
	    	...
	    	Tools.d(AbFileUtil.class, "下载图片异常："+e.getMessage());
		}
		return bit;
	}
	...
	public static Bitmap getBitmapFromSrc(String src){
		...
		try {
	    	...
	    	Tools.d(AbFileUtil.class, "获取图片异常："+e.getMessage());
		}
		return bit;
	}
 	 ...
 	 */
 	 public static String downloadFile(String url,String dirPath){
 		 ...
 		 try {
 			...
 			e.printStackTrace();
 			Tools.e(AbFileUtil.class, "有文件下载出错了,已删除");
	...
	public static int getContentLengthFromUrl(String Url){
		...
		try {
	    	 ...
	    	 e.printStackTrace();
	    	 Tools.d(AbFileUtil.class, "获取长度异常："+e.getMessage());
		}
    ...
    public static String getRealFileNameFromUrl(String url){
        ...
        try {
            ...
            e.printStackTrace();
            Tools.e(AbFileUtil.class, "网络上获取文件名失败");
        }
        return name;
    }
    ...
    public static String getRealFileName(HttpResponse response){
        ...
        try {
            ...
            e.printStackTrace();
            Tools.d(AbFileUtil.class, "网络上获取文件名失败");
        }
        return name;
    }
	...
	public static void initFileDir(Context context){
		...
		PackageInfo info = Tools.getPackageInfo(context);

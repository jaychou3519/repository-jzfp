...
public class ArchivesEditActivity2 extends BaseActivity implements WebServiceCallback{
		...
		if(reulst == null){
    		...
    		case 100:
    			if (requestCode == 100) {// 提交贫困户信�?
    				if ("1".equals(reulst)) {
    					Intent intent = new Intent(this,ArchivesActivity2.class);
    					startActivity(intent);
    					finish();
    					MyApplication.finishActivityByName("ArchivesDetailsActivity2");
    					MyApplication.finishActivityByName("ArchivesPoorActivity2");
    					MyApplication.finishActivityByName("ArchivesActivity2");
    				}
    			}
    			break;
			case 101:

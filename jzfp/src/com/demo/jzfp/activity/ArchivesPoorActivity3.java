...
public class ArchivesPoorActivity3 extends BaseActivity implements WebServiceCallback{

	private String TAG = "ArchivesPoorActivity3";
	...
	private Handler handler = new Handler(){
		public void handleMessage(android.os.Message msg) {
			...
			case 201:
				...
				adapter = new ArchivesPoorAdapter2(ArchivesPoorActivity3.this,countrys);
	...
	protected void initData() {
		...
		String countid = bundle.getString("countid");
		if(bundle.getBoolean("state")){
			LinkedHashMap<String, String> linkedHashMap = new LinkedHashMap<String, String>();
			linkedHashMap.put("arg0", bundle.getString("countrymanId"));
			linkedHashMap.put("arg2", countid);
			RequestWebService.send(methodName, linkedHashMap, this, 102);
			Tools.i(TAG, "接口="+methodName+"arg0="+bundle.getString("countrymanId")+"  arg1="+countid);
		}else{

...
public class ArchivesDetailsActivity2 extends BaseActivity implements WebServiceCallback{
	...
	public void mClick(View view) {
		...
		case R.id.iv_edit:
			...
			Tools.setOpenActivityBundle(this, ArchivesEditActivity2.class,bundle);
			break;
